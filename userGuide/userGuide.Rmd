...
\label{13}
$$
Further, the slope of $c$-$\mu$ curve is approximated according to the phase diagram in the solver source code.
...
* Constant value from temperature profile ($T_i$) = 0.93
...
The results reconstructed to time directories can be viewed using ParaView by opening the *freeGrowth.foam* case module. The evolution of phase-field profile corresponding to three time steps are shown in Figure 4-6.
...
Similar to section 1.4, the results reconstructed to time directories can be viewed by opening the *directionalSolidification.foam* case module using ParaView. The evolution of phase-field profile corresponding to three time steps are shown in Figure 9-11.
